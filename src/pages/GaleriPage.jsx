...
const GaleriPage = () => {
  ...
  return (
    <div className="bg-background text-on-surface font-body-md antialiased pt-[72px] min-h-screen">
      {/* Navbar */}
      <Navbar />
        ...
        <div className="max-w-max-width mx-auto px-margin-mobile md:px-margin-desktop">
          <AnimatePresence mode="wait">
            <motion.div
              ...
              animate="visible"
              exit="exit"
              className="grid grid-cols-2 md:grid-cols-4 auto-rows-[200px] gap-3 md:gap-4"
            >
