...
const AdminPengaduan = () => {
  ...
  */
  ...
  |--------------------------------------------------------------------------
  |
  | Digunakan untuk FOTO BUKTI PRIVATE.
  | Tidak menggunakan href langsung karena endpoint membutuhkan token.
  |
  */
  ...
  */
  ...
  |--------------------------------------------------------------------------
  |
  | Digunakan untuk DOKUMEN PENDUKUNG PRIVATE.
  |
  */
    ...
    async (
      ...
      */
      ...
      try {
        /*
        |--------------------------------------------------------------------------
        | Request Private File Dengan Axios
        |--------------------------------------------------------------------------
        |
        | Axios interceptor otomatis menambahkan:
        |
