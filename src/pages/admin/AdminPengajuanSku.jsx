                ...
                <>
                        ...
                        >
                          ...
                          <div className="mt-6 space-y-4">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              {selected.visit_date && (
                                <div className={`rounded-xl bg-white/70 border px-4 py-4 ${
                                  isExpired(
                                    selected
                                  )
                                    ? 'border-slate-200'
                    ...
                    <section>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="md:col-span-2">
                          <InfoRow
                            label="Alamat Usaha"
                            value={`${selected.alamat_usaha || '-'} RT ${
                              selected.rt_usaha ||
                              '-'
                            } / RW ${
                              selected.rw_usaha ||
                  ...
                  <div className="px-6 py-4 border-t border-outline-variant/20 flex flex-wrap justify-end gap-3 shrink-0">
                    ...
                    <button
                      ...
                      className="px-4 py-2 rounded-xl border border-outline-variant text-on-surface-variant hover:bg-surface-container-low"
                    >
                      Tutup
                    </button>
                  </div>
