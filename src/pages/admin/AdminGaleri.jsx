...
const AdminGaleri = () => {
  ...
  */
  ...
  | Karena itu foto tidak langsung digunakan sebagai <img src="">.
  | Kita ambil sebagai blob dengan Axios.
  |
  */
  ...
  const loadFotoUrl =
    useCallback(
      async (
        ...
        /*
        |--------------------------------------------------------------
        | Kalau resource mengirim URL endpoint
        |--------------------------------------------------------------
        */
  ...
  const handleDelete =
    async (
      ...
      try {
        ...
        /*
        |------------------------------------------------------------------
        | Tutup modal jika gambar yang sedang dibuka dihapus
        |------------------------------------------------------------------
        */
