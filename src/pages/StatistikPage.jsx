  ...
  return (
    <div className="bg-background text-on-surface antialiased flex flex-col min-h-screen">
        ...
        <div className="min-h-screen bg-surface">
            ...
            {/* ====== MAIN CONTENT ====== */}
            <main className="flex-grow pt-[104px] pb-xl px-margin-mobile md:px-margin-desktop max-w-max-width mx-auto w-full">
                ...
                <div className="bg-surface-container-lowest rounded-xl p-lg shadow-sm border border-outline-variant/30">
                    ...
                    <div className="flex items-center gap-sm">
                        ...
                        <div className="flex-grow bg-surface-container rounded-full h-3">
