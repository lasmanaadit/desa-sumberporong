        ...
        <main className="p-6 lg:p-8 max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="font-body-md text-on-surface-variant mt-2">
              Kelola pengajuan administrasi dan produk UMKM Anda
              dengan lebih mudah melalui Sistem Informasi Desa.
            </p>
          </motion.section>
          ...
          <section className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5 mb-8">
            ...
            <StatCard
              title="Produk UMKM"
              value="3"
              description="Produk yang diajukan"
              icon="storefront"
          ...
          <motion.section
            ...
            className="mt-6"
          >
            <h2 className="font-headline-md text-on-background text-xl mb-4">
              Akses Cepat
            </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <button
                type="button"
                onClick={() => navigate('/dashboard/umkm/tambah')}
                className="
                  bg-surface-container-lowest
                  border border-outline-variant/20
                  rounded-xl
