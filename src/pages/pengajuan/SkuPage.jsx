// src/pages/dashboard/SkuPage.jsx
...
const SkuPage = () => {
  ...
  // Handler khusus untuk tanggal lahir dengan format dd/mm/yyyy
          ...
          <div className="max-w-5xl mx-auto">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="font-headline-lg text-on-background">Surat Keterangan Usaha</h1>
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="font-body-md text-on-surface-variant mt-1">
                    Pastikan data pemohon dan data usaha yang dimasukkan sudah benar dan sesuai dengan kondisi sebenarnya.
                  </p>
                </div>
              </div>
            </motion.div>

            <TataCara jenisSurat="surat pengantar SKU" />
              ...
              >
                ...
                <section>
                  ...
                  <div className="mt-6 space-y-5">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                      ...
                      <div>
                        <label className="font-label-md text-on-surface block mb-2">Agama</label>
                        <select
                          name="agama"
                          value={form.agama}
                          onChange={handleChange}
                    ...
                    {/* ALAMAT */}
                    <div>
                      <label className="font-label-md text-on-surface block mb-2">Alamat Tempat Tinggal</label>
                      <textarea
                        name="alamat"
                        value={form.alamat}
                        onChange={handleChange}
                ...
                <section className="border-t border-outline-variant/20 pt-8 mt-8">
                  <div className="flex items-center gap-3 mb-1">
                    ...
                    <div>
                      <h2 className="font-headline-md text-xl text-on-background">Data Usaha</h2>
                      <p className="font-label-sm text-on-surface-variant tracking-normal">
                  ...
                  <div className="mt-6 space-y-5">
                    {/* NAMA USAHA */}
                    <div>
                      <label className="font-label-md text-on-surface block mb-2">Nama Usaha</label>
                      <input
                        type="text"
                        name="namaUsaha"
                    ...
                    {/* JENIS USAHA */}
                    <div>
                      <label className="font-label-md text-on-surface block mb-2">Jenis Usaha</label>
                      <select
                        name="jenisUsaha"
                    ...
                    {/* DESKRIPSI USAHA */}
                    <div>
                      <label className="font-label-md text-on-surface block mb-2">Deskripsi Usaha</label>
                      <textarea
                        name="deskripsiUsaha"
                    ...
                    {/* ALAMAT USAHA */}
                    <div>
                      <label className="font-label-md text-on-surface block mb-2">Alamat Usaha</label>
                      <textarea
                        name="alamatUsaha"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                      <div>
                        <label className="font-label-md text-on-surface block mb-2">RT Tempat Usaha</label>
                        <input
                          type="text"
                          name="rtUsaha"
                          value={form.rtUsaha}
                      ...
                      <div>
                        <label className="font-label-md text-on-surface block mb-2">RW Tempat Usaha</label>
                        <input
                          type="text"
                          name="rwUsaha"
                          value={form.rwUsaha}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                      <div>
                        <label className="font-label-md text-on-surface block mb-2">Lama Menjalankan Usaha</label>
                      ...
                      <div>
                        <label className="font-label-md text-on-surface block mb-2">Perkiraan Penghasilan per Bulan</label>
                        <select
                          name="penghasilan"
                        ...
                        >
                          ...
                          <option value="dibawah-1-juta">Di bawah Rp1.000.000</option>
                          <option value="1-5-juta">Rp1.000.000 - Rp5.000.000</option>
                          <option value="5-10-juta">Rp5.000.000 - Rp10.000.000</option>
                          <option value="diatas-10-juta">Di atas Rp10.000.000</option>
                        </select>
                      </div>
                    </div>
                  </div>
                ...
                <section className="border-t border-outline-variant/20 pt-8 mt-8">
                  <div className="flex items-center gap-3 mb-1">
                    ...
                    <div>
                      <h2 className="font-headline-md text-xl text-on-background">Dokumen Pendukung</h2>
                      <p className="font-label-sm text-on-surface-variant tracking-normal">
                  ...
                  <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-5">
                    {/* KTP */}
                    <div>
                      <label className="font-label-md text-on-surface block mb-2">Kartu Tanda Penduduk (KTP)</label>
                      <input
                        type="file"
                        name="dokumenKtp"
                      ...
                      />
                      <p className="font-label-sm text-on-surface-variant mt-2 tracking-normal">JPG, PNG atau PDF</p>
                    </div>

                    {/* KK */}
                    <div>
                      <label className="font-label-md text-on-surface block mb-2">Kartu Keluarga (KK)</label>
                      <input
                        type="file"
                        name="dokumenKK"
                        onChange={handleFileChange}
                    ...
                    <div className="md:col-span-2">
                      <label className="font-label-md text-on-surface block mb-2">Foto Tempat / Kegiatan Usaha</label>
                      <input
                        type="file"
                        name="fotoUsaha"
                        onChange={handleFileChange}
